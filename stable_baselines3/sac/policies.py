...
from stable_baselines3.common.torch_layers import (
    ...
    CombinedExtractor,
    CombinedExtractorWithLoadedImageEncoder,
    FlattenExtractor,
    NatureCNN,
    create_mlp,
...
class MultiInputPolicyWithLoadedImageEncoder(SACPolicy):
    """
    Policy class (with both actor and critic) for SAC with loaded image encoders.
    ...
    def __init__(
        ...
        use_expln: bool = False,
        clip_mean: float = 2.0,
        features_extractor_class: type[BaseFeaturesExtractor] = CombinedExtractorWithLoadedImageEncoder,
        features_extractor_kwargs: dict[str, Any] | None = None,
        normalize_images: bool = True,
        optimizer_class: type[th.optim.Optimizer] = th.optim.Adam,
        optimizer_kwargs: dict[str, Any] | None = None,
